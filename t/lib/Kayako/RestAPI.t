...
subtest "get_ticket_statuses" => sub {
    ...
    my $expected = {
          ...
          '9' => {
                 ...
                 'statuscolor' => {},
                 'departmentid' => '0',
                 'displayicon' => 'http://ts.acelaboratory.com/__swift/files/file_uw8cs2d09hfwl2f.png',
                 'resetduetime' => '0',
                 'displayorder' => '2',
                 'staffvisibilitycustom' => '0',
                 'triggersurvey' => '0',
          ...
          '3' => {
                 'displayicon' => 'http://ts.acelaboratory.com/__swift/files/file_yo47r8tff1vwu8v.png',
                 'departmentid' => '0',
                 'statuscolor' => '#000000',
                 'displaycount' => '0',
                 'markasresolved' => '1',
